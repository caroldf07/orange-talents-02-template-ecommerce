...
@Service
public class NotaFiscal implements ChamadaExterna {

    @Override
    public void executa(@NotNull @Valid Compra compra) {
        RestTemplate restTemplate = new RestTemplate();
        Map<String, Object> notaFiscalRequest = Map.of("idCompra", compra.getId(), "idComprador", compra.getComprador().getId());
